...
std::vector<float> test_data = {55.43, 78.76, 43.83, 1.14,  98.50, 2.79,  29.80, 90.06, 65.44, 92.80, 87.86, 62.11,
                                72.78, 14.68, 31.69, 48.14, 57.24, 70.79, 93.75, 9.28,  18.05, 8.68,  6.23,  73.46};
// 45.41, 32.59, 28.32, 57.32, 8.73,  61.63, 2.70,  16.51, 53.18, 58.40, 22.92, 30.94
// 40.17, 7.66,  17.23, 9.61,  41.01, 64.25, 92.30, 82.79, 19.08,
...
void loop() {
  ...
  delay(1000);
  MatrixProfile::Mpx mpx(test_data, 10, 0.5, 0);
  if (!done) {
    mpx.ComputeStream();
    done = 1;
  }
