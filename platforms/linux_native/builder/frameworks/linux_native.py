...
# FRAMEWORK_DIR = platform.get_package_dir("framework-linux_native")

# env.Append(CPPDEFINES=["_GNU_SOURCE"], CPPPATH=[join(FRAMEWORK_DIR, "linux_native")])
...
# libs.append(
#     env.BuildLibrary(
#         join("$BUILD_DIR", "FrameworkLinuxNative"),
#         join(
#             env.PioPlatform().get_package_dir("framework-linux_native"), "linux_native"
#         ),
#     )
# )
