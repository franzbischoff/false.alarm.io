...
# FRAMEWORK_DIR = platform.get_package_dir("framework-windows_native")

# env.Append(CPPDEFINES=["_GNU_SOURCE"], CPPPATH=[join(FRAMEWORK_DIR, "windows_native")])
...
# libs.append(
#     env.BuildLibrary(
#         join("$BUILD_DIR", "FrameworkWindowsNative"),
#         join(
#             env.PioPlatform().get_package_dir("framework-windows_native"), "windows_native"
#         ),
#     )
# )
...
#     FRAMEWORK_DIR = platform.get_package_dir("framework-arduino-avr-%s" %
#                                              build_core.lower())
...
# CPPDEFINES = [("F_CPU", "$BOARD_F_CPU"), "ARDUINO_ARCH_AVR",
#               ("ARDUINO", 10808)]
...
#             ("CLOCK_SOURCE", board.get("build.clock_source", 0)))
...
#     libs.append(
#         env.BuildLibrary(join("$BUILD_DIR", "FrameworkArduinoVariant"),
